...
const NumbersBalloons = () => {
  ...
  return (
    <div className="container">
      <Helmet>
        <meta charSet="utf-8" />
        <title>{t('categoryNumbersBalloons')} </title>
        <meta
          name="description"
          content="купить шарики киев, шарики воздушные, воздушные шары киев, шары киев"
        />
        <link
          rel="canonical"
          href="https://www.sharik-upp.com/folgirovannye-cifry"
        />
      </Helmet>
      <h1 className="content__title">
        <img src="/data/imаges/layered-heart.svg" alt="heart" />
        {t('categoryNumbersBalloons')}{' '}
        <img src="/data/imаges/layered-heart.svg" alt="heart" />
      </h1>
      {status === 'error' ? (
...
export default NumbersBalloons
