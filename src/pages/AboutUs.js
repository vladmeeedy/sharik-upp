  ...
  return (
    <div className="container">
      ...
      <div className="container--about">
        <p>Компания "ШарикАп" это</p>
        <p>
          <TbHexagonNumber1 /> компания, которая работает с 2019 года на рынке
          доставки воздушных шариков и праздничных аксесуаров по городу Киеву.
          Интернет магазин "Sharik-upp" предоставляет отличный выбор различных
          шаров с гелием под Ваш праздник. Заходите на наш сайт, выберите
          подходящий вариант, и мы доставим вашу покупку в любой район Киева и в
          любое время! Просто позвоните по одному из наших телефонных номеров и
          сделайте ваш заказ!
        </p>
        <p>
          <TbHexagonNumber2 />
